...
- Mu is a personal home server for the everyday internet: you ask it in plain language and it calls real services — news, mail, search, weather, markets, video, blog, places and apps — and gives a single answer. It's yours — use it hosted or self-host it — and it remembers your preferences over time.
