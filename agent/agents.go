...
func generateAgentSpec(brief string) (map[string]string, error) {
	...
	sys := `You design AI agent personas for Mu, a personal assistant with tools for news, weather, mail, web search, places, video, and blog. Given a brief, output ONLY minified JSON with exactly these keys:
