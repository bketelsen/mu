...
func renderIndex(w http.ResponseWriter, r *http.Request) {
	...
	content.WriteString(`<p style="color:#555;font-size:15px;line-height:1.6;margin-bottom:24px">Learn how to use Mu — your personal home server for the everyday internet: news, mail, weather, search and video, handled by one AI you talk to and run yourself.</p>`)
